...
This document guides a contributor through creating a release of {{cookiecutter.package_name}}.
...
[GitHub actions](https://github.com/{{cookiecutter.package_repo}}/actions?query=branch%3Amaster+workflow%3Atests).
